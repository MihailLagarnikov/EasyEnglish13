...
open class TestC @SuppressLint("ValidFragment") constructor
    ...
    private fun setDataTopFr(){
        try {
            ...
            dataTop.typeTest=TypeTest.TestC
    ...
    private fun answerDone(succes:Boolean){
        if (!mAnswerNotDone) {
            ...
            mModel.setVisibleElements(mDataVisibile)
            mModel.mPresenter.testDone(TypeTest.TestC,mDataVisibile.answerTrue)
        }
    }
    ...
    protected open fun callKeyboard(){
        ...
        binding.editTextTestCD.post(Runnable {
            ...
            inputMethodManager!!.toggleSoftInputFromWindow(
                binding.editTextTestCD.getApplicationWindowToken(), InputMethodManager.SHOW_IMPLICIT, 0
            )
